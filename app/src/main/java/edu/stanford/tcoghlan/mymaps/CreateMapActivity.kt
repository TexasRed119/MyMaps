...
import edu.stanford.tcoghlan.mymaps.databinding.ActivityCreateMapBinding
...
class CreateMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (intent == null) {
            Log.w(TAG, "intent is null, unable to get map title")
            return true
        }
        //check that 'item' is save menu icon
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(siliconValley, 5f))
    }
